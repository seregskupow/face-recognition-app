...
const ActorPageComponent: FC<ActorPageProps> = ({
  knownFor,
  image,
  name,
  birthday,
  ...
  const fetchFilms = useCallback(async (filmArr) => {
    const filmNames = filmArr.map((item: any) => ({
      ...
      {filmData.length > 0 && (
        <div className='actor-films page'>
                    ...
                    <div className='film-details'>
                      ...
                      <div className='film-info'>
                        <p className='item-appear'>
                          <span>Metascore:</span> {film.rating1}
                          /100
                        </p>
          ...
          <div className='slider-arrow-wrapper'>
            ...
            <div className='slider__arrows--right slider__arrow'>&#10095;</div>
          </div>
        </div>
      )}
    </>
