...
export default class FaceMatch extends Component {
	...
	async start() {
		...
		imageUpload.addEventListener('change', async () => {
			...
			let imageToUpload = document.createElement("img");
			var reader = new FileReader();
			reader.onload = function (event) {
				imageToUpload.src = event.target.result;
			};
				...
				<div className="face-matcher">
					...
					>
						<button
							type="button"
							style={{
								display: `${dataReady || recognitionFailed
									? 'block'
									: 'none'
									}`,
							}}
							...
							<div className="demo-img-wrapper">
								...
								<div className="demo-img-container">
									<div
										...
										style={{
											pointerEvents: `${disableUpload === true ? 'none' : 'auto'
												}`,
										}}
										onClick={() => {
											this.urlUpload(AlPacino);
